...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_CAPS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_MINS,    KC_EQL,     KC_LBRC, KC_RBRC, KC_PIPE,
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NUHS,    KC_NUBS,    KC_AMPR, KC_BSLS, _______,
...
[_RAISE] = LAYOUT_planck_grid(
    _______,  _______, KC_UP,   KC_MENU, _______, _______, _______, _______,  _______, _______, _______, KC_DEL,
    KC_CAPS,  KC_LEFT, KC_DOWN, KC_RGHT, KC_PGUP, _______, _______,  KC_HOME, _______, _______, _______, _______,
    _______, _______, _______, _______,  KC_PGDN, _______, _______,  KC_END,  _______, _______, _______, _______,
